	...
	<body class="no-skin">
													...
													<div class="form-horizontal">
														...
														<div class="form-group">
															<div class="col-xs-12">
																...
																<div class=" col-sm-3">
																	...
																	<select type="number" class="form-control" id="buildingAreaRentForm"  name="buildingAreaRentForm">
																...
																<div class=" col-sm-3">
																	<div>
																		<label for="buildingAreaRentTo">Diện Tích Đến</label>
																		<input type="number" id="buildingAreaRentTo"  class="form-control" />
																	</div>
																</div>
																<div class=" col-sm-3">
																	<div>
																		<label for="buildingCostRentForm">Giá Thuê Từ</label>
																		<input type="number" id="buildingCostRentForm"  class="form-control" />
																	</div>
																</div>
																
																<div class=" col-sm-3">
																	<div>
																		<label for="buildingCostRentTo">Giá Thuê Đến</label>
																		<input type="number" id="buildingCostRentTo"  class="form-control" />
																	</div>
																</div>
														...
														<div class="form-group">
															<div class="col-xs-12">
																...
																<div class=" col-sm-4">
																	<div>
																		<label for="phone">Điện Thoại Quản Lý</label>
																...
																<div class=" col-sm-4">
																	...
																	<label for="buildingDistrict">Chọn Nhân Viên Phụ Trách</label>

																	<select class="form-control" id="">
																		<option value=""hidden>--Chọn Nhân Viên Phụ Trách--</option>
																	</select>
																</div>
																<!-- PAGE CONTENT ENDS -->
															</div><!-- /.col -->
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<button class="btn btn-xs btn-info" data-toggle="tooltip" title="Giao Tòa nhà"
														title="Giao Tòa Nhà" onclick="assingmentBuilding()">
										...
										<tr>
											...
											<td>
												<button class="btn btn-xs btn-info" data-toggle="tooltip" title="Giao Tòa nhà"
														title="Giao Tòa Nhà" onclick="assingmentBuilding(2)">
		...
		<!--  AssingmentBuildingModal -->
			...
			<script>
				...
				$('#btnAsssignBuilding').click(function (e) { 
					e.preventDefault();
					//call api
					var data={};
					var staffs=[];
